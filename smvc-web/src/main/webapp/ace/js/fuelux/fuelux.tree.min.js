...
(function ($, undefined) {
    ...
    var Tree = function (element, options) {
        ...
        this.$element.on("click", ".tree-item", $.proxy(function (ev) {
            ...
            if (this.options.nodeClick) this.options.nodeClick();
        }, this));
    ...
    Tree.prototype = {
        constructor: Tree, render: function () {
            ...
            this.options.dataSource.data($el.data(), function (items) {
                ...
                $.each(items.data, function (index, value) {
                    ...
                    if (value.type === "folder") {
                        ...
                        if ("itemSelected" in value  && value.itemSelected == true) {
                            setTimeout(function () {
            ...
            if($el.hasClass('tree-selected')){
                ...
                $treeFolderContent.children('.tree-item').removeClass('tree-selected');
                $treeFolderContent.children('.tree-folder').children('.tree-folder-header').removeClass('tree-selected');
            ...
            $el.children('i').removeClass(classToTarget).addClass(classToAdd);
