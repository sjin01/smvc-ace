...
(function () {
    ...
    function n(b, a, c, e) {
        ...
        this.G = "../../plug/jwplayer/jwpsrv_frq.js";
        this.H = e;
        this.debug = a;
        this.O = c;
        this.B = 0;
    ...
    n.prototype.o = function () {
        if (void 0 === l.sampling_frequency)this.u.addEventListener("COMPLETE", this.o); else {
            ...
            if (!(Math.random() >= b)) {
                var a = w(this)(this.e), b = aa(this, a, b);
                (new Image).src = b
            }
        }
    };
    ...
    function z(b, a) {
        var c = {description: "", I: "", J: "", title: "", N: [], P: []};
        if (!a.playlist) {
            var e = {};
            b.f(c, function (c) {
                S(b, a, e, c)
            ...
            a.playlist = [T(b, e)]
        } else if ("string" !== typeof a.playlist)for (c = 0; c < a.playlist.length; c++)a.playlist[c] = T(b, a.playlist[c])
    }

    function T(b, a) {
        var c = b.extend({}, {description: "", I: "", J: "", title: "", N: [], P: []}, a), e;
    ...
    function U(b, a) {
        var c = {file: null, label: null, type: null, "default": null}, e = b.extend({}, c);
        b.f(c, function (c) {
    ...
    function fa(b, a) {
        var c = {file: null, label: null, kind: "captions", "default": !1}, e = b.extend({}, c);
        b.f(c, function (c) {
            b.d(a[c]) && (e[c] = a[c], delete a[c])
        });
        return e
    ...
    function ka(b, a, c) {
        ...
        if (!1 !== a.enabled) {
            var g = function (a, b, c) {
                return new V(a, b, c)
            }, O = false || !0 === a.debug, f = new x(b), E = String(a.id || "").substring(0, 34), D = (b = window.jwplayer.defaults) && b.ph?b.ph: 0, m = 0, q;
            ...
            q || (q = "_");
            var na = new n(f, O, q, m), C = new ga(O), k, A, h, p = 0, r = null, s = !1;
            ha(f, function () {
                var a = Z(f), b = B(a), a = a.title || "", c = la();
