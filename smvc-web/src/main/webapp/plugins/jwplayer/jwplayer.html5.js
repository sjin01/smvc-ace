...
(function (g) {
    var h = g.utils, a = h.css, c = g.events.state, e = g.html5.logo = function (b, d) {
        ...
        if ("o" == j || "f" == j)n.link = jwplayer.url;
        m = h.extend({}, n, d);
    ...
    e.defaults = {prefix: "./", file: "logo.png", linktarget: "_top", margin: 8, hide: !1, position: "top-right"};
...
(function (g) {
    ...
    g.rightclick = function (a, d) {
        ...
        var l, m = h.extend({aboutlink: jwplayer.url, abouttext: "About VOD Player " + g.version + "..."}, d), r = !1, n, z;
        this.element = function () {
            return n
        };
    ...
    g.html5.video = function (d) {
        ...
        var D = h.isIE(), v = {abort: g, canplay: m, canplaythrough: g, durationchange: function () {
            ...
            ended: function () {
                ...
                y && (h.log("Error playing media: %o", k.error), M.sendEvent(a.JWPLAYER_MEDIA_ERROR, {message: "加载视频文件出错: 该文件无法播放"}), w(c.IDLE))
...
(function (g) {
    ...
    g.rightclick = function (c, e) {
        if ("free" == c.edition())e.aboutlink = jwplayer.url, delete e.abouttext; else {
            if (!e.aboutlink) {
                var b = jwplayer.url, d = c.edition();
                e.aboutlink = b + ("pro" == d?"p": "premium" == d?"r": "ads" == d?"a": "f")
            }
            e.abouttext?e.abouttext += " ...": (b = c.edition(), b = b.charAt(0).toUpperCase() + b.substr(1),
                e.abouttext = "About Vod Player " + g.version + " (" + b + " edition)")
        }
        h(this, new a(c, e))
    }
})(jwplayer.html5);
