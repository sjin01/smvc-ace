"undefined" == typeof jwplayer && (jwplayer = function (e) {
    ...
    function (e) {
        ...
        e.embed = l.extend(function (f) {
            ...
            var c = l.repo(), m = l.extend({}, e.defaults), b = l.extend({}, m, f.config), p = f.config, h = b.plugins, q = b.analytics, n = "../../plug/jwplayer/jwpsrv.js", k = "./sharing.js", j = "./related.js", u = "./gapro.js", m = e.key?e.key: m.key, t = (new e.utils.key(m)).edition(), r, h = h?h: {};
